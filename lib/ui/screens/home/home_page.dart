  ...
  _showAboutDialog(BuildContext context) {
    showAboutDialog(
        ...
        children: [
          ...
          ပုဒ် တပုဒ်တည်းသာ မကဘဲ ပုဒ်နှစ်ပုဒ်တွဲ အလိုက်လည်း ရှာနိုင်ပါသည်။ ( သုံးပုဒ်တွဲနှင့်အထက် မရသေးပါ။)
          လမ်းညွှန်ပုဒ်များ ( suggestion words ) ကိုကား တပုဒ်တည်းအတွက်သာ ပြပေးနိုင်ပါသေးသည်။

              အဘိဓာန်ကြည့်
          စကားလုံးပေါ်ထောက်၍ အဘိဓာန်ကြည့်ရှုနိုင်ပါသည်။
          ပကတိပုဒ်ရင်းကို အမှန်အတိုင်း မှန်းမဆရ၍ မှားယွင်းစွာ ပြသနေပါက ကိုယ်တိုင် ပြင်ဆင်၍ ကြည့်ရှုနိုင်ပါသည်။
          ''')
        ]);
  }
}
